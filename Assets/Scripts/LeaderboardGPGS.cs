...
// for working with google play games services for leaderboard
public class LeaderboardGPGS : MonoBehaviour
{
    ...
    {
        Social.ReportScore(score, GPGSIds.leaderboard_sky_ball, (success) =>
        {
