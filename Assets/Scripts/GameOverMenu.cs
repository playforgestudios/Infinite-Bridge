...
public class GameOverMenu : MonoBehaviour {
	...
	public TextMeshProUGUI lblBestScore;
...
//		}
	...
	void InitializeUserInterface()
	{
		...
		lblCoins.GetComponent<TextMeshProUGUI>().text = PlayerPrefs.GetInt("TotalCoins", 0).ToString();
...
//			}
	...
	void CheckForShopButtonAnimation()
	{
		...
		{
			iTween.ScaleTo(m_btnShop.gameObject,
				iTween.Hash("x", .25f, "y", .25f, "easetype", iTween.EaseType.easeOutElastic, "looptype", "loop",
					"time", 1));
		}
	}
